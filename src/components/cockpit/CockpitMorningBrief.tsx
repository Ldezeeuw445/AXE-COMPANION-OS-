 ...
 * Briefs are pre-generated by cron (06:00 local daily, Monday 06:00 weekly) via GPT.
 */
    ...
    return (
      <GlassPanel className="p-5">
        ...
        {delivering ? (
          ...
          <p className="mt-3 text-sm leading-relaxed text-tos-muted">
            Your personalized brief is prepared at <span className="text-tos-text">06:00</span> in your
            local timezone so it is ready when you open the app.
          </p>
        )}
