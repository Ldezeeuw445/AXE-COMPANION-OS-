...
export function ChartNewsDrawer({ open, onClose, symbol }: Props) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-[var(--tos-topbar-offset)] z-[45] flex h-[calc(100svh-var(--tos-topbar-offset)-var(--tos-nav-offset))] w-[92vw] max-w-[420px] flex-col border-r border-white/10 bg-[#0c0c0c]/96 shadow-[0_24px_72px_rgba(0,0,0,0.6)] backdrop-blur-2xl transition-transform duration-200 ease-out ${
